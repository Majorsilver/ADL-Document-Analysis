"""5-layer CNN for 1x68x136 word images, with a 7x7 first conv.
...
The wider first kernel gives the input layer a bigger receptive field over
raw pixels (cross-out strokes can be several pixels wide), then later
blocks stick with 3x3.
"""
