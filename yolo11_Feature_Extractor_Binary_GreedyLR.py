...
def train():
    wandb.init(project="cross-out-detection", name="Yolo11 - Binary - FeatureExtraction - No Preprocessing", config=CONFIG) # Setup wandb
    ...
    patience_counter = 0
    best_model_path = "Best_models/Yolo11_FeatureExtractor_Binary_NoPreprocessing_.pth"
